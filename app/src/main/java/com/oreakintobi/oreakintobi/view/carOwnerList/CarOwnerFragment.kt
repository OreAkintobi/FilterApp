...
import com.oreakintobi.oreakintobi.databinding.FragmentCarOwnerListBinding
import com.oreakintobi.oreakintobi.viewModel.owner.CarOwnerViewModel
import com.oreakintobi.oreakintobi.viewModel.owner.CarOwnerViewModelFactory
...
class CarOwnerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        carOwnerViewModel.filterResult.observe(viewLifecycleOwner, Observer { filteredResult ->
