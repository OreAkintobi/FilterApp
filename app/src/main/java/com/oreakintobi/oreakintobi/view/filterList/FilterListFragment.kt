...
import com.oreakintobi.oreakintobi.databinding.FragmentFilterListBinding
import com.oreakintobi.oreakintobi.network.Network.isNetworkAvailable
import com.oreakintobi.oreakintobi.repository.FilterRepository
import com.oreakintobi.oreakintobi.viewModel.filter.FilterListViewModel
import com.oreakintobi.oreakintobi.viewModel.filter.FilterListViewModelFactory
...
class FilterListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        filterListViewModel.filterList.observe(viewLifecycleOwner, Observer { filterList ->
            filterList?.let {
                filterListViewModel.grantAccess.observe(viewLifecycleOwner, Observer {
                    if (it) {
        ...
        filterListViewModel.startDialogDownload.observe(viewLifecycleOwner, Observer {
            if (!it) {
        ...
        filterListViewModel.completeDownload.observe(viewLifecycleOwner, Observer { isCompleted ->
